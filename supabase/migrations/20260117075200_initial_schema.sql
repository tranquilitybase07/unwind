...
INSERT INTO categories (name, description, emoji, display_order, is_system) VALUES
  ...
  ('Errands', 'Shopping, appointments, admin tasks', '=Ò', 3, true),
  ('Health', 'Medical, fitness, nutrition, mental health', 'd', 4, true),
  ('Relationships', 'People, communication, social obligations', '=e', 5, true),
