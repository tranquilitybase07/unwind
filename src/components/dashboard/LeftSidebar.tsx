  ...
  return (
    <aside className="w-20 bg-white flex flex-col items-center py-6 space-y-6 shadow-sm">
      ...
      <Link href="/" className="flex flex-col items-center gap-2 mb-4">
        ...
        <span className="text-xs font-bold text-gray-900">Unwind</span>
      </Link>
      ...
      <div className="flex-1 flex flex-col items-center space-y-4 pt-4">
        <Link
          href="/dashboard"
          className={`group relative w-12 h-12 rounded-full flex items-center justify-center transition-colors ${
            isActive("/dashboard") 
        ...
        >
          ...
          <span className="absolute left-16 px-3 py-1.5 bg-gray-900 text-white text-sm font-medium rounded-lg opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none z-50">
            Dashboard
          </span>
        </Link>
        ...
        <Link 
          ...
          className={`group relative w-12 h-12 rounded-full flex items-center justify-center hover:cursor-pointer transition-colors ${
